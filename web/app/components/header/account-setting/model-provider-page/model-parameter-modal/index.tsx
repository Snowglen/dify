      ...
      <div className="relative">
        ...
        <PortalToFollowElemContent className={cn('z-[60]', portalToFollowElemContentClassName)}>
          <div className={cn(popupClassName, 'w-[389px] rounded-2xl border-[0.5px] border-components-panel-border bg-components-panel-bg shadow-lg')}>
            ...
            {!hideDebugWithMultipleModel && (
              <div
                className="flex h-[50px] cursor-pointer items-center justify-between rounded-b-xl border-t border-t-divider-subtle bg-components-panel-bg px-4 text-text-accent system-sm-regular hover:bg-components-panel-on-panel-item-bg-hover"
              ...
              >
                ...
                <span className="i-custom-vender-line-arrows-arrow-narrow-left h-3 w-3 rotate-180" />
              </div>
            )}
          </div>
        </PortalToFollowElemContent>
